...
The broader programmatic library also maps every public module in the pinned Zed UI and `gpui-kit` catalogs to a real Native SDK entry point. See [GPUI UI Library Parity](/docs/ui-library-parity) for the complete 107-module inventory and ownership rules.
